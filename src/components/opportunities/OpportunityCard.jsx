...
export default function OpportunityCard({ opportunity, match, compact = false, onSave }) {
  const [isSaved, setIsSaved] = React.useState(match?.status === 'saved' || false);
          ...
          <div className="flex justify-between items-center gap-3 pt-2 border-t border-slate-100">
            {opportunity.source_url && (
              <Button variant="outline" size="sm" asChild className="flex-1 max-w-xs">
                <a href={opportunity.source_url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
            ...
            <Button
              ...
              className={isSaved ? "bg-neura-teal hover:bg-neura-lightTeal text-white" : "hover:bg-teal-50 border-neura-teal text-neura-teal"}
            >
