...
export default function Pipeline() {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case 'saved': return <Bookmark className="w-4 h-4 text-neura-teal" />;
      case 'pursuing': return <Target className="w-4 h-4 text-neura-slate" />;
      case 'submitted': return <Clock className="w-4 h-4 text-neura-blueGray" />;
      case 'won': return <Trophy className="w-4 h-4 text-green-500" />;
      case 'lost': return <XCircle className="w-4 h-4 text-neura-coral" />;
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'saved': return 'bg-teal-50 text-neura-teal border-neura-teal';
      case 'pursuing': return 'bg-slate-100 text-neura-slate border-neura-slate';
      case 'submitted': return 'bg-blue-50 text-neura-blueGray border-neura-blueGray';
      case 'won': return 'bg-green-100 text-green-800 border-green-200';
      case 'lost': return 'bg-red-50 text-neura-coral border-neura-coral';
